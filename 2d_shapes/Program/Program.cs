...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
            CreatedShapes.addShape(new Circle(5, new (2,3)));
            CreatedShapes.addShape(new Rectangle(3,4, new(2, 3)));
            CreatedShapes.addShape(new Circle(5, new(2, 3)));
        }
        ...
        //Console.WriteLine(CreatedShapes.arrShapes[0].Id);
        //Console.WriteLine(((Circle)CreatedShapes.arrShapes[0]).Radius);
